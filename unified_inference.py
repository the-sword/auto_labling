...
from app import DetectionResult as OriginalDetectionResult
...
class UnifiedInferenceEngine:
    ...
    def segment(self, image: Image.Image, labels: List[str], threshold: float = 0.3) -> List[OriginalDetectionResult]:
        """
        对单张图片进行分割
    ...
    def segment_batch(self, images: List[Image.Image], labels: List[str], threshold: float = 0.3) -> List[List[OriginalDetectionResult]]:
        """
        批量处理多张图片
